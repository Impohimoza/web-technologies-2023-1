...
const game = {
  ...
  canSetDirection(direction) {
    ...
    return !(direction === 'up' && lastStep === 'down') &&
           !(direction === 'down' && lastStep === 'up') &&
           !(direction === 'left' && lastStep === 'right') &&
           !(direction === 'right' && lastStep === 'left');
  },
  ...
  canMakeStep() {
    ...
    return !this.snake.isOnPoint(nextPoint) || 
           ...
           nextPoint.y < this.config.getRowsCount());
  },
};
